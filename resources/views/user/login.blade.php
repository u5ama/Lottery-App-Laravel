  ...
  <body>
    <div class="adminLogin">
      ...
      <form action="{{ route('user.check') }}" method="post">
        ...
        <div class="row px-3">
          <button type="submit" class="col btn btn-dark mt-4">Login</button>
          <div class="col mt-4 pt-2 text-center">OR</div>
          <a href="{{ route('user.signup') }}" class="col btn btn-dark mt-4">Signup</a>
        </div>
      </form>
    </div>
  </body>
