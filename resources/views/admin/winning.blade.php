...
<x-sidebar activepage="winning" :activeuser="$activeuser" />
...
<div id="content">
  ...
  <div class="row">
    <div class="col-7">
      ...
      @endif
      <form action="{{ route('admin.winning') }}" method="post">
        @csrf
        <div class="row">
          <h5>Enter Numbers to make Winning Combination:</h5>
          <input name="adminWinning[]" type="number" class="col m-3" min="1" max="41" required>
          <input name="adminWinning[]" type="number" class="col m-3" min="1" max="41" required>
          <input name="adminWinning[]" type="number" class="col m-3" min="1" max="41" required>
          <input name="adminWinning[]" type="number" class="col m-3" min="1" max="41" required>
          <input name="adminWinning[]" type="number" class="col m-3" min="1" max="41" required>
